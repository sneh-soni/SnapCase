...
// Email in jsx like syntax using react-email
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img
              src={`${baseUrl}/packaging-for-delivery.png`}
              width="65"
              height="73"
              alt="delivery image"
              style={{ margin: "auto" }}
            ...
            <Text style={global.text}>
              We're preparing for your delivery and will notify you once your
